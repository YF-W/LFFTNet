...
class LFFTNet_SN2(nn.Module):
    def __init__(self, features=[64, 128, 256, 512], out_channels=1):
        super(LFFTNet_SN2, self).__init__()
        ...
        self.upconv_1 = DoubleConv(in_channels=512 + 65, out_channels=512)
        self.upconv_2 = DoubleConv(in_channels=256 + 65, out_channels=256)
        self.upconv_3 = DoubleConv(in_channels=128 + 65, out_channels=128)
        self.upconv_4 = DoubleConv(in_channels=64 + 65, out_channels=64)
