...
class Bottleneck(nn.Module):
    def __init__(self):
        ...
        self.p2_2 = nn.Conv2d(1024, 1024, 3, 1, 1, bias=False)
        self.p3_2 = nn.Conv2d(1024, 1024, 3, 1, 1, bias=False)
        self.p3_4 = nn.ConvTranspose2d(1024, 1024, kernel_size=2, stride=2)
        self.final = DoubleConv(1024, 1024)
...
class LFFTNet_SN5(nn.Module):
    def __init__(self, features=[64, 128, 256, 512], out_channels=1):
        super(LFFTNet_SN5, self).__init__()
